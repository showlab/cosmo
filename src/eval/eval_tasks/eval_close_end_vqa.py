"""
The eval_vqa.py is for open-ended VQA evaluation.
This file is for close-ended VQA evaluation.
For example:
Q. A1, A2, A3, A4. Then select one answer from A1, A2, A3, A4.

part of implementation from LAVIS: https://github.com/salesforce/LAVIS/blob/main/lavis/models/blip_models/blip_vqa.py
"""



import os
from cosmo.src.eval.data.video_mc_dataset import CLOSEENDVQADataset
...
def evaluate_vqa(
    ...
    train_dataset = CLOSEENDVQADataset(
    ...
    test_dataset = CLOSEENDVQADataset(
